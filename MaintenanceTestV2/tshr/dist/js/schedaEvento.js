...
var schedaEvento=(function(){'use strict';function _inheritsLoose(subClass, superClass) {
...
function _setPrototypeOf(o, p) {
  ...
  return Page;
}();var SchedaEvento = function (_Page) {
  _inheritsLoose(SchedaEvento, _Page);

  function SchedaEvento(el) {
    var _this;
  ...
  var _proto = SchedaEvento.prototype;
...
window.onload = function () {
  var schedaevento = new SchedaEvento();
};return SchedaEvento;}());